...
export default function GameCard({ game }: props) {
    ...
    return <Link
        to={`/games/${game.id}`}
        className="block relative hover:scale-105 transition bg-cover bg-center m-3 w-full min-w-[26rem] max-w-[36rem] h-36 rounded-xl text-slate-950 border-2 border-slate-950"
